					...
					<div class="row m-5">
						...
						<div class="col-sm-10">
							<textarea readonly class="form-control-plaintext"
								id="inputContent" rows="10">${qa.qaContent}</textarea>
						</div>
					</div>

					<div class="row m-5">
						<label for="date" class="col-sm-2 col-form-label">작성일</label>
						<div class="col-sm-10">${requestScope.qa.qaDate}</div>
					</div>
					...
					<div class="row m-5" align="right">
						...
						<div class="col-sm-2">
							<button type="button" class="btn btn-light"
								onclick="location.href='${path}/front?key=notice&methodName=select'">목록</button>
						</div>
					</div>
