...
public interface UserDAO {
	 ...
	 * */
	public boolean idCheck(String uId)throws SQLException;
	 ...
	 * */
	public String idFind(String uJumin, String uPhone)throws SQLException;
	
	/**
	 * 비밀번호 찾기 SELECT U_PWD FROM USERS WHERE U_ID=? AND U_JUMIN = ? AND U_PHONE =?
	 * */
	public String pwdFind(String uId ,String uJumin, String uPhone)throws SQLException;
